...
const typeConfig = {
  User: {
    ...
    bgColor: 'bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-600 text-slate-600 dark:text-slate-300',
  ...
  <div class="space-y-3">
    ...
    <div class="relative">
      ...
      <div
        ref="triggerRef"
        @click="isOpen = !isOpen"
        class="w-full px-4 py-3 border-2 rounded-xl bg-white dark:bg-slate-800 cursor-pointer flex items-center justify-between transition-all duration-200"
        :class="isOpen
      ...
      <Teleport to="body">
        ...
        >
          <div
            v-if="isOpen"
            class="fixed z-[9999] bg-white dark:bg-slate-900 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden"
            :style="dropdownStyle"
          >
            <!-- Search -->
            <div class="p-3 border-b border-gray-100 dark:border-gray-800">
              <div class="relative">
                ...
                <input
                  ...
                  class="w-full pl-10 pr-4 py-2.5 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-white dark:bg-slate-800 text-gray-900 dark:text-white text-sm"
                  @click.stop
                />
              </div>
            </div>
