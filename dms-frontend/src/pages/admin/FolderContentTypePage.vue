          ...
          <div class="bg-white dark:bg-background-dark rounded-lg shadow-sm border border-gray-200 dark:border-border-dark p-4">
            ...
            <div class="mb-4">
              ...
              <select
                ...
                class="w-full px-3 py-2 border border-gray-300 dark:border-border-dark rounded-lg bg-white dark:bg-surface-dark text-gray-900 dark:text-white"
              >
            ...
            <!-- Folder Tree -->
            <div v-if="selectedCabinetId" class="border border-gray-200 dark:border-border-dark rounded-lg max-h-96 overflow-y-auto">
              ...
              <div v-else class="p-2">
                <div
                  ...
                  :key="folder.id"
                  class="flex items-center gap-2 px-2 py-1.5 rounded cursor-pointer hover:bg-gray-100 dark:hover:bg-border-dark"
              ...
              <div v-for="(types, category) in groupedContentTypes" :key="category">
                ...
                <div class="space-y-1 pl-5">
                  <div
                    v-for="ct in types"
                    :key="ct.id"
                    class="flex items-center gap-2 p-2 bg-gray-50 dark:bg-surface-dark rounded text-sm"
                  >
        ...
        <div class="col-span-8">
          <div class="bg-white dark:bg-background-dark rounded-lg shadow-sm border border-gray-200 dark:border-border-dark p-6">
            ...
            <template v-else>
              ...
              <div v-else-if="folderAssignments.length === 0" class="text-center py-12 bg-gray-50 dark:bg-surface-dark rounded-lg">
              ...
              <div v-else class="space-y-4">
                <div
                  ...
                  :key="assignment.id"
                  class="flex items-center justify-between p-4 bg-gray-50 dark:bg-surface-dark rounded-lg border border-gray-200 dark:border-border-dark"
                >
      ...
      <div class="bg-white dark:bg-background-dark rounded-lg shadow-xl w-full max-w-md mx-4 p-6">
        ...
        <div class="space-y-4">
          <div>
            ...
            <select
              ...
              class="w-full px-4 py-2 border border-gray-300 dark:border-border-dark rounded-lg bg-white dark:bg-surface-dark text-gray-900 dark:text-white"
            >
        ...
        <div class="mt-6 flex justify-end gap-3">
          <button
            ...
            class="px-4 py-2 border border-gray-300 dark:border-border-dark rounded-lg hover:bg-gray-50 dark:hover:bg-surface-dark"
          >
            Cancel
          </button>
          <button
